...
export const projects: projectType[] = [
  {
    ...
    name: "Remonth",
    description:
      "일상의 소중한 순간을 기록하고 공유하며 할 수 있는 아카이빙 형태의 반응형 프로젝트입니다.",
    detailInfo:
      "Remonth는 '다시'를 뜻하는 접두사 'Re-'를 'month'와 결합하여 만든 단어입니다. 좋은 영화, 사랑하는 사람과 함께한 순간, 맛있는 음식 등 일상의 소중한 순간을 기록하고 공유하며 추억을 간직할 할 수 있는 형태의 프로젝트입니다.",
    year: "2023",
    techStack: [
      "React.js",
      "Redux Toolkit",
